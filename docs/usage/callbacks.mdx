...
<Playground>
  {() => {
    ...
    function onClickMarker(marker, markerObject, event, _parameters) {
      setEvent({
        type: 'CLICK',
        marker,
    ...
    function onTouchMarker(marker, markerObject, event, _parameters) {
      setEvent({
        type: 'TOUCHSTART',
        marker,
        markerObjectID: markerObject.uuid,
    ...
    function onMouseOutMarker(previousMarker, markerObject, event, _parameters) {
      setEvent({
        type: 'MOUSEOUT',
        previousMarker,
    ...
    function onMouseOverMarker(marker, markerObject, event, _parameters) {
      setEvent({
        type: 'MOUSEOVER',
        marker,
        markerObjectID: markerObject.uuid,
