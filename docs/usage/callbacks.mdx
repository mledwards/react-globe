...
<Playground>
  {() => {
    ...
    function onClickMarker(marker, markerObject, event, {_tooltip, _options}) {
      setEvent({
        type: 'CLICK',
        marker,
    ...
    function onTouchMarker(marker, markerObject, event, {_tooltip, _options}) {
      setEvent({
        type: 'TOUCHSTART',
        marker,
        markerObjectID: markerObject.uuid,
    ...
    function onMouseOutMarker(previousMarker, markerObject, event, {_tooltip, _options}) {
      setEvent({
        type: 'MOUSEOUT',
        previousMarker,
    ...
    function onMouseOverMarker(marker, markerObject, event, {_tooltip, _options}) {
      setEvent({
        type: 'MOUSEOVER',
        marker,
        markerObjectID: markerObject.uuid,
