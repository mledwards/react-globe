...
<Playground>
  {() => {
    ...
    function onClickMarker(marker, markerObject, event, globe) {
      setEvent({
        type: 'CLICK',
        marker,
    ...
    function onTouchMarker(marker, markerObject, event, globe) {
      setEvent({
        type: 'TOUCHSTART',
        marker,
        markerObjectID: markerObject.uuid,
    ...
    function onDefocus(previousCoordinates, globe) {
      setEvent({
        type: 'DEFOCUS',
        previousCoordinates,
      });
    ...
    function onMouseOutMarker(previousMarker, markerObject, event, globe) {
      setEvent({
        type: 'MOUSEOUT',
        previousMarker,
    ...
    function onMouseOverMarker(marker, markerObject, event, globe) {
      setEvent({
        type: 'MOUSEOVER',
        marker,
        markerObjectID: markerObject.uuid,
