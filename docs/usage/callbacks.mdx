...
<Playground>
  {() => {
    ...
    function onClickMarker(marker, markerObject, event, {tooltip, options}) {
      setEvent({
        type: 'CLICK',
        marker,
    ...
    function onTouchMarker(marker, markerObject, event, {tooltip, options}) {
      setEvent({
        type: 'TOUCHSTART',
        marker,
        markerObjectID: markerObject.uuid,
    ...
    function onDefocus(previousCoordinates, _parameters) {
      setEvent({
        type: 'DEFOCUS',
        previousCoordinates,
      });
    ...
    function onMouseOutMarker(previousMarker, markerObject, event, {tooltip, options}) {
      setEvent({
        type: 'MOUSEOUT',
        previousMarker,
    ...
    function onMouseOverMarker(marker, markerObject, event, {tooltip, options}) {
      setEvent({
        type: 'MOUSEOVER',
        marker,
        markerObjectID: markerObject.uuid,
