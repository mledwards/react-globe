...
export default class Globe {
  ...
  defocus() {
    if (!this.isLocked && this.previousFocus && this.options.enableDefocus) {
      this.callbacks.onDefocus(this.previousFocus, this);
    }
  }
  ...
  updateMarkers(markers = []) {
    ...
    const callbacks = {
      onClickMarker: (marker, markerObject, event) => {
        this.callbacks.onClickMarker(marker, markerObject, event, this);
      },
      onTouchMarker: (marker, markerObject, event) => {
        this.callbacks.onTouchMarker(marker, markerObject, event, this);
      },
      onMouseOutMarker: (marker, markerObject, event) => {
        this.callbacks.onMouseOutMarker(marker, markerObject, event, this);
      },
      onMouseOverMarker: (marker, markerObject, event) => {
        this.callbacks.onMouseOverMarker(marker, markerObject, event, this);
      },
    };
