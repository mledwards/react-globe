...
export const defaultCallbacks = {
  onClickMarker: (_marker, _markerObject, _event) => true,
  onTouchMarker: (_marker, _markerObject, _event) => true,
  onDefocus: (_previousFocus, _shouldDefocus) => true,
  onGlobeBackgroundTextureLoaded: () => {},
  onGlobeCloudsTextureLoaded: () => {},
  onGlobeTextureLoaded: () => {},
  onMouseOutMarker: (_marker, _markerObject, _event) => true,
  onMouseOverMarker: (_marker, _markerObject, _event) => true,
};
