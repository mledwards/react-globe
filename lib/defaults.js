...
export const defaultCallbacks = {
  onClickMarker: (marker, _markerObject, _event, globe) => {
    globe.updateFocus(marker.coordinates);
  },
  onTouchMarker: (marker, _markerObject, _event, globe) => {
    globe.updateFocus(marker.coordinates);
  },
  onDefocus: (_previousFocus, globe) => {
    globe.updateFocus(null);
  },
  onGlobeBackgroundTextureLoaded: () => {},
  onGlobeCloudsTextureLoaded: () => {},
  onGlobeTextureLoaded: () => {},
  onMouseOutMarker: (_marker, _markerObject, _event, globe) => {
    globe.tooltip.hide();
  },
  onMouseOverMarker: (_marker, markerObject, event, globe) => {
